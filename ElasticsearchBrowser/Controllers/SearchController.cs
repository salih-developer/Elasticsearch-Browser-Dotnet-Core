...
namespace ElasticsearchBrowser.Controllers
{
    ...
    public class SearchController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var mapping = this.client.Instance.GetMapping(new GetMappingRequest(Nest.Indices.Index(rs.Key.Name)));
            ...
            var documents = this.client.Instance.Search<Dictionary<string, object>>(x => x.Index(rs.Key.Name).AllTypes().MatchAll());
        ...
        [HttpGet]
        public IActionResult GetJsonObject(int id)
        {
